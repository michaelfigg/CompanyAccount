...
define([
    ...
    'uiRegistry',
    'mage/translate',
    'Tigren_CompanyAccount/customer/js/model/customer-addresses',
    'Tigren_CompanyAccount/js/model/shipping-rate-service'
], function (
    $,
    _,
    Component,
    ...
    return Component.extend({
        defaults: {
            template: 'Tigren_CompanyAccount/checkout/shipping',
