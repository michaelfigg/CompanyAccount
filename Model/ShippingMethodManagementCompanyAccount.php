 ...
 */
class ShippingMethodManagementCompanyAccount implements
    ...
    ShipmentEstimationInterface
{
    ...
    protected $_companyAccountAddressFactory;
    ...
    public function __construct(
        ...
        \Tigren\CompanyAccount\Model\AccountAddressFactory $companyAccountAddressFactory,
        ...
        $this->_companyAccountAddressFactory = $companyAccountAddressFactory;
    ...
    public function estimateByAddressId($cartId, $addressId)
    {
        ...
        if($this->_companyAccountHelper->getCustomerEnableEnterShippingAddress($this->_currentCustomer->getCustomerId()) != '1'){
            $addressData = $this->_companyAccountAddressFactory->create()->load($addressId)->getData();
            $this->_addressInterface->setCity($addressData['city']);
            $this->_addressInterface->setPostcode($addressData['postcode']);
            $this->_addressInterface->setRegion($addressData['region']);
            $this->_addressInterface->setRegionId($addressData['region_id']);
            $this->_addressInterface->setCountryId($addressData['country_id']);
            $this->_addressInterface->setStreet([$addressData['street']]);
            $this->_addressInterface->setCompany($addressData['company']);
            $this->_addressInterface->setFax($addressData['fax']);
            $this->_addressInterface->setPrefix($addressData['prefix']);
            $this->_addressInterface->setSuffix($addressData['suffix']);
            $this->_addressInterface->setVatId($addressData['vat_id']);
            $this->_addressInterface->setTelephone($addressData['telephone']);
            $address = $this->_addressInterface;
        }else
